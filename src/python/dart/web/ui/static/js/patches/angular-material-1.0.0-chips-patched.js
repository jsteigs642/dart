 ...
 */
MdChipsCtrl.prototype.resetChipBuffer = function(value) {
  // ---- RMN PATCH: add "value" parameter
  value = value || '';
  if (this.userInputElement) {
    if (this.userInputNgModelCtrl) {
      this.userInputNgModelCtrl.$setViewValue(value);
      this.userInputNgModelCtrl.$render();
    } else {
      this.userInputElement[0].value = value;
    }
  } else {
    this.chipBuffer = value;
  }
};
